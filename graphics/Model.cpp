...
void Model::traverseNode(unsigned int nextNode, glm::mat4 matrix)
{
    ...
    glm::mat4 matNextNode = matrix * matNode * translation * rot * sca;
...
{
    // Create a place to store the ra text, and get the uri of the .bin file.
    ...
    // Transform the raw text datqa into bytes and put them in a vector:
